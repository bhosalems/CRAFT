...
class Qwen3_OmniHFInferenceEngine:
    def __init__(self, config: AppConfig) -> None:
        ...
        self.processor = Qwen3OmniMoeProcessor.from_pretrained(config.model, cache_dir=config.cache_dir)
        # get 0-9
    ...
    def generate_batch(self, batch_data: list[dict[str, any]]) -> list[str]:
        ...
        score_logits = logits[:,self.processor.tokenizer.convert_tokens_to_ids(self.score_token)]
